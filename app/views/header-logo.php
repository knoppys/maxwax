...
<body style="background: url(<?php echo CONFIG['IMAGES']; ?>/background.jpg) no-repeat center center fixed;">

    <div class="header-nav">
        <div class="container-fluid">
            <div class="row">
                <div class="col-4 click-nav-link">
                    <i class="fa fa-solid fa-info-circle me-3 pa-text-fa pa-text-30 pa-text-secondary"></i>
                    <span>Menu</span>
                </div>
                <div class="col-4 inner-logo">
                    <img src="https://max-wax.co.uk/wp-content/uploads/2024/02/20-Years-Logo-white.png" alt="">
                </div>
                <div class="col-4 click-nav-link text-right">
                    <?php
